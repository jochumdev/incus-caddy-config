...
services:
  web:
    ...
    labels:
      edge: "web.example.test,upstream=80"
```
...
| ----------------------- | ------------------------------------------------------------------------------------------------------------------------------------- |
| `edge`                  | **(Required)** Domain name(s) with optional flags (e.g. `,upstream=8080`, `,network=incusbr0`, `,redir=https://new.com`, `,template=custom.caddyfile`). Multiple domains separated by spaces. |
